...
public class Main {
    public static void main(String[] args) {
        ...
        ArenaFighter hero = new ArenaFighter("Arslan", 100, 0.20, 25, 5, 18, 3);
        ArenaOpponent opponent = new ArenaOpponent("Dark Knight", 90, 14);
        ...
        ArenaFighter tournamentHero = new ArenaFighter(
                "Erlan", 120, 0.25, 25, 8, 22, 3
        );
        ArenaOpponent tournamentOpponent = new ArenaOpponent(
                "Iron Vane", 100, 16
        );
